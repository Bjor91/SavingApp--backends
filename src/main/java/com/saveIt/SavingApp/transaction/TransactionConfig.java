...
public class TransactionConfig {
    ...
    CommandLineRunner TransActionCommandLineRunner(TransactionRepository repository) {
        return args -> {
            ...
            Transaction txn002 = new Transaction("txn002", "2023-08-14", "Paycheck Deposit", 40000.0, "NOK", "acc123");
            ...
            Transaction txn006 = new Transaction("txn006", "2023-08-14", "Savings Deposit", 1500.0, "NOK", "acc456");
            Transaction txn007 = new Transaction("txn007", "2023-08-14", "Savings Deposit", 1000.0, "NOK", "acc012");
            Transaction txn008 = new Transaction("txn008", "2023-08-14", "Paycheck Deposit", 26000.0, "NOK", "acc789");
            Transaction txn009 = new Transaction("txn009", "2023-08-08", "Savings Deposit", 2500.0, "NOK", "acc456");
            Transaction txn010 = new Transaction("txn010", "2023-08-14", "Savings Deposit", 2500.0, "NOK", "acc456");
            Transaction txn011 = new Transaction("txn011", "2023-08-06", "Savings Deposit", 7000.0, "NOK", "acc012");
            Transaction txn012 = new Transaction("txn012", "2023-08-20", "Savings Deposit", 7000.0, "NOK", "acc012");
            Transaction txn013 = new Transaction("txn013", "2023-08-29", "Online Shopping", -5000.0, "NOK", "acc012");
